...
export default function HealthcareRiskManagementPage() {
    return (
            ...
            <section className="border-b border-gray-200 bg-gray-50">
                <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 py-12 md:py-16 lg:px-16">
                    ...
                    <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                        Effective management of healthcare risks through systematic approaches
                    </p>
                </div>
            </section>
                ...
                <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-16 space-y-8">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mt-12 space-y-10">
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Managing Complications</h2>
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Critical Patient Transfer Protocol</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Medical Records & Documentation</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Schedule of Hospital Charges</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Adverse Events Management</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Proper Grievance Redressal</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <div>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Hospital Violence Management</h2>
                                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
