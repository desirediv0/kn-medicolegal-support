            ...
            <section className="border-b border-gray-200 bg-gray-50">
                <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 py-12 md:py-16 lg:px-16">
                    ...
                    <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                        For Healthcare Risk Prevention & Management
                    </p>
                </div>
            </section>
                ...
                <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-16 space-y-8">
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="mt-12 space-y-10">
                            <section>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Prevention of Litigations</h2>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">3. Continuous Professional Development and Quality Improvement</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">4. Communication skills</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">5. Second opinion & referral</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">6. Managing Complications</h3>
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">7. Critical Patient Transfer Protocol</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">8. Medical Records</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">9. Schedule of hospital charges</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">10. Proper Indemnity Insurance</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">11. Adverse Events</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">12. Proper Grievance Redressal</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">13. Hospital Violence</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">14. Responsible professional bodies</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-semibold text-gray-900 mb-6">Management of Litigation</h2>

                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">1. When you receive a legal notice</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">2. When you receive the notice from the Consumer Court</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">3. How to select a medicolegal consultant/advocate for your defence</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">4. When you receive a summons from the police</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900 mb-3">5. FIR & Criminal Proceedings</h3>
                                        <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
